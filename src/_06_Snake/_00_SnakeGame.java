...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Control the snake with the arrow keys. Eat the apples without running into yourself or the boundaries.";
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "Your snake is dead. Congrats");
		//3. ask them if they want to play again.
		String s = JOptionPane.showInputDialog("Would you like to play again? YES or NO");
